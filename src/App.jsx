...
export default function App() {
  ...
  const sidebarHeightStyle = { height: '100vh', top: 0 };
  const mainContentHeightStyle = { height: '100vh' };
  ...
  return (
    ...
    >
      ...
      <header
        ...
        id="mobile-header"
        className="hidden max-md:flex bg-sidebar border-b border-border-sidebar px-5 py-3 items-center gap-4 fixed left-0 right-0 top-0 z-[90] h-[60px] shadow-[0_2px_10px_rgba(0,0,0,0.02)]"
      >
        <button
      ...
      >
        ...
        {/* Tool Stage */}
        <section className={`tool-stage w-full flex-1 flex flex-col items-center px-12 max-md:px-[14px] max-[500px]:px-[10px] ${staticTools.has(activeTool) ? 'tool-stage--static py-4 md:py-1.5 max-md:pt-[100px] md:max-h-[calc(100vh-98px)] md:overflow-y-auto' : 'py-8 max-md:pt-[100px]'}`}>
          {renderActiveTool()}
        </section>
