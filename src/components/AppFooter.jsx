...
const externalLinkClass = `${footerLinkClass} inline-flex items-center gap-1.5`;
  ...
  return (
    <footer className="mt-auto w-full border-t border-border bg-footer">
      ...
      <div className="mx-auto w-full max-w-[1200px] px-12 py-4 text-[0.78rem] text-text-muted max-md:px-8 max-[500px]:px-4">
        <div className={`flex flex-wrap items-center justify-between gap-x-6 gap-y-3 max-md:flex-col max-md:items-start ${showSitemap ? 'border-t border-border pt-4' : ''}`}>
          ...
          <div className="flex flex-wrap items-center gap-x-5 gap-y-2 max-md:gap-x-3">
            ...
            <nav aria-label={t('navigation:footer.external')} className="flex flex-wrap items-center gap-x-3 gap-y-2">
              ...
              <a href="https://rhosiqs.com" target="_blank" rel="noopener noreferrer" className={externalLinkClass} title={t('navigation:footer.website')}>
                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><circle cx="12" cy="12" r="10" /><line x1="2" y1="12" x2="22" y2="12" /><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" /></svg>
                {t('navigation:footer.websiteLabel')} ↗
              </a>
              <a href={PROJECT_REPOSITORY_URL} target="_blank" rel="noopener noreferrer" className={externalLinkClass} title={t('navigation:footer.github')}>
